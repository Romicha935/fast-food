   ...
   <div className='container'>
      <div className='grid grid-cols-3 pt-5'>
        ...
        <div className='py-8 px-4'>
            <h1 className='sm:text-3xl text-xl font-bold sm:text-left text-justify mb-3 flex items-center gap-3'>Fast Food</h1>
                ...
                <ul className='flex flex-col gap-3'>
                    {
                        FooterLinks.map((link)=>(
                            <li className='cursor-pointer hover:text-blue-600 hover:translate-x-1 duration-300 text-gray-200' key={link.title}>
